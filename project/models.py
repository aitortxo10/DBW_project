...
languages_challenges = db.Table('languages_challenges',
                                db.Column('challenges_id', db.Integer, db.ForeignKey('challenges.id'), primary_key=True),
                                db.Column('programming_languages_id', db.Integer, db.ForeignKey('programming_languages_id'), primary_key=True),
                                db.Column('example_code', db.Text))

challenges_stats = db.Table('challenges_stats',
                            db.Column('challenges_id', db.Integer, db.ForeignKey('challenges_id'), primary_key=True),
                            db.Column('users_id', db.Integer, db.ForeignKey('users_id'), primary_key=True),
                            db.Column('start_date', db.DateTime),
                            db.Column('end_date', db.DateTime),
                            db.Column('tries', db.Integer),
                            db.Column('solved', db.Boolean),
                            db.Column('programming_languages_id', db.Integer, db.ForeignKey('programming_languages_id')))
